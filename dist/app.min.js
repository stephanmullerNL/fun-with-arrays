(function e(t, n, r) {
    ...
    5: [ function(require, module, exports) {
        (function() {
            "use strict";
            angular.module("app").controller("case2Controller", Case2Controller);
    ...
    7: [ function(require, module, exports) {
        (function() {
            "use strict";
            angular.module("app").controller("case4Controller", Case4Controller);
            Case4Controller.$inject = [ "$scope", "employees" ];
            function Case4Controller($scope, employees) {
                var _ = require("lodash"), apeldoornEmployees = employees, totalAge;
        ...
        (function() {
            ...
            function DataService($http, $window) {
                ...
                function getData(name) {
                    return $http.get("./datas/" + name + ".json").then(function(response) {
